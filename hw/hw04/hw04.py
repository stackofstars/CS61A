...
def replace_leaf(t, find_value, replace_value):
    ...
    return tree(label(t), [replace_leaf(s, find_value, replace_value) for s in branches(t)])
...
def has_path(t, phrase):
    ...
    def help(t, phrase, string=label(t)):
        if phrase == string:
            return True
        else:
            for i in branches(t):
                if help(i, phrase, string+label(i)):
                    return True
        return False
    return help(t, phrase)
